...
OBSTACLE_GEOMETRIES = [
    Box["x,y,z", 0:20*  RES           , 0:RES, 0.00     :0.20*  RES],
    Box["x,y,z", 0:20*  RES           , 0:RES, 2.80* RES:3.00*  RES],
    Box["x,y,z", 0:1.45*RES           , 0:RES, 0.20* RES:0.43*  RES],
    Box["x,y,z", 0:0.30*RES           , 0:RES, 0.66* RES:2.56*  RES],
    Box["x,y,z", 1.70*  RES:2*     RES, 0:RES, 0.20* RES:2.80*  RES],
    Box["x,y,z", 0.30*  RES:1.45*  RES, 0:RES, 0.66* RES:0.90*  RES],
    Box["x,y,z", 0.30*  RES:1.45*  RES, 0:RES, 1.70* RES:1.97*  RES],
    Box["x,y,z", 0.30*  RES:1.45*  RES, 0:RES, 2.30* RES:2.55*  RES],
    Box["x,y,z", 0.55*  RES:1.7*   RES, 0:RES, 1.15* RES:1.42*  RES]
...
INFLOW = CenteredGrid(Box["x,y,z", 0.31*RES:0.45*RES, 0.35*RES:0.75*RES, 0.5* RES:0.65*RES ], extrapolation.BOUNDARY, **DOMAIN) * 0.2 + \
         CenteredGrid(Box["x,y,z", 0.31*RES:0.45*RES, 0.35*RES:0.75*RES, 1.1* RES:1.5* RES ], extrapolation.BOUNDARY, **DOMAIN) * 0.2 + \
         CenteredGrid(Box["x,y,z", 0.31*RES:0.45*RES, 0.35*RES:0.75*RES, 2.05*RES:2.2* RES ], extrapolation.BOUNDARY, **DOMAIN) * 0.2 + \
         CenteredGrid(Box["x,y,z", 0.31*RES:0.45*RES, 0.35*RES:0.75*RES, 2.6* RES:2.75*RES ], extrapolation.BOUNDARY, **DOMAIN) * 0.2
